                ...
                mainPanel(
                        tabsetPanel(type = "tabs",
                                    tabPanel('Description',
                                             h5("This app is developed for xcmsSet object and related csv file data visualization."),
                                             br(),
                                             p("You need to process data locally with ",a("xcms package",href = "https://bioconductor.org/packages/release/bioc/html/xcms.html"), "and", a("enviGCMS package",href = "https://cran.r-project.org/web/packages/enviGCMS/index.html"), "in", a("R",href = "https://www.r-project.org/")," and upload the xcmsSet object or csv file to this app. The following code would help:"),
                                             br(),
                                             code(
                                                     "BiocInstaller::biocLite('xcms')",br(),
                                                     "install.package('enviGCMS')",br(),
                                                     "library(xcms)",br(),
                                                     "library(enviGCMS)",br(),
                                                     "path <- './data'",br(),
                                             ...
                                             p("You could find the csv file to be uploaded in your working folder and you could also download a demo cse file", a("here",href = "https://github.com/yufree/xcmsplus/blob/master/test.csv?raw=true")),
                                             br(),
                                             p("After uploading, you could see the result by hitting different tabs"),
                                             "Contact me by click",
                                             a("here", href = "mailto:yufreecas@gmail.com"),
                                             'or just add an issue on',
                                             a("Github",href = "https://github.com/yufree/xcmsplus"), "if you have questions."
                                    ),
                        tabPanel("Peaks",            
                        plotOutput("plot1"),
                        plotOutput("plot2")),
                        ...
                        plotOutput("plot5")),
                        tabPanel("References",
                                 p("If you use this application for publication, please cite this application as webpages and related papers:"),
                                 h6("Miao Yu, Xingwang Hou, Qian Liu, Yawei
